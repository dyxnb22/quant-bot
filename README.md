...
研究迭代记录：体制闸门假设（熊市关敞口）已被三管线 walk-forward 对比**证伪**——闸门确实降低熊市亏损，但错过的牛市早段代价更大（`docs/results/04-regime-filter-comparison.md`）。部署决策按预登记标准执行，拒绝了"听起来合理"的改动；下一步方向是更快的体制定义或更换 alpha 信息源。
