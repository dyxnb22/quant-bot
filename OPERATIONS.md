...
| 触发条件 | 动作 |
|---|---|
| ~~22 号报告自动生成~~（已完成 2026-08-13：INCONCLUSIVE，任务自卸载） | 归档完毕；zz500 财报下载继续为数据资产（深夜自动续传至完成） |
...
- 点时审计（23 号）：CN/US 财报三数据域 0 硬违规；协议 v4（可实施性/塌缩警报/功效估计）已生效
- 质量基线：126 测试 / lint 全绿 / CI 绿 / data-check 四数据域全绿（币市/us/cn/cn500）
